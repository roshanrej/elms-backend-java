...
public interface LeavePolicyRepository extends JpaRepository<LeavePolicyEntity, Long> {
    ...
    boolean existsByLeaveTypeAndYear(LeaveTypeEntity leaveType, Integer year);

    LeavePolicyEntity findByLeaveTypeAndYear(LeaveTypeEntity leaveType, Integer year);
